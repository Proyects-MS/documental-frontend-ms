...
import ProfileUser from '../Pages/App Pages/ProfileUser';
import Roles from '../Pages/App Pages/Roles';
import Processes from '../Pages/App Pages/Processes';
import Process from '../Pages/App Pages/Process';
import File from '../Pages/App Pages/File';
import Tasks from '../Pages/App Pages/Tasks';
import History from '../Pages/App Pages/History';
import Repository from '../Pages/App Pages/Repository';
import Home from '../Pages/App Pages/Home';
import FileHistory from '../Pages/App Pages/FileHistory';
import Contration from '../Pages/App Pages/Contration';
import TypeSubprocess from '../Pages/App Pages/TypeSubprocess';
import Procedure from '../Pages/App Pages/Procedure';



export const routes = [
    { path: `${process.env.PUBLIC_URL}/herramientas/usuarios`, Component: <Users/> },
    { path: `${process.env.PUBLIC_URL}/herramientas/ajustes`, Component: <Settings/> },
    { path: `${process.env.PUBLIC_URL}/usuario/perfil`, Component: <ProfileUser/> },
    { path: `${process.env.PUBLIC_URL}/procesos`, Component: <Processes/> },
    { path: `${process.env.PUBLIC_URL}/proceso`, Component: <Process/> },
    { path: `${process.env.PUBLIC_URL}/herramientas/roles`, Component: <Roles/> },
    { path: `${process.env.PUBLIC_URL}/archivo`, Component: <File/> },
    { path: `${process.env.PUBLIC_URL}/tareas`, Component: <Tasks/> },
    { path: `${process.env.PUBLIC_URL}/historial`, Component: <History/> },
    { path: `${process.env.PUBLIC_URL}/repositorio`, Component: <Repository/> },
    { path: `${process.env.PUBLIC_URL}/dashboard`, Component: <Home/> },
    { path: `${process.env.PUBLIC_URL}/historialarchivo`, Component: <FileHistory/> },
    ////tyop de procesos 
    { path: `${process.env.PUBLIC_URL}/Subprocesos`, Component: <TypeSubprocess/> },
    { path: `${process.env.PUBLIC_URL}/contratacion`, Component: <Contration/> },
    { path: `${process.env.PUBLIC_URL}/Procedimiento`, Component: <Procedure/> },
