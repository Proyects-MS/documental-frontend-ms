                    ...
                    < Fragment key={i} >
                      {Item.Items.map((menuItem, i) => (
                        <LI attrLI={{ className: 'sidebar-list' }} key={i}>
                          ...
                          {menuItem.type === 'link' ? permissions[menuItem.id] ? 
                            permissions[menuItem.id].is_allowed === 1 && (
                            <>
                          ...
                          {menuItem.children && (
                            <UL attrUL={{
                              ...
                              {menuItem.children.map((childrenItem, index) => {
                                  const permission = permissions[childrenItem.id];
                                  return (
                                    <LI key={index}>
                                      {permission && permission.is_allowed === 1 && (
                                        <Link
