...
export const tableColumns = [
  ...
  },
  {
    ...
    name: "Contrataciones",
    selector: (Row) =>
      Row["id_hiring"] ? Row["id_hiring"]["name"] : "No tiene contrataciones",
    sortable: true,
    center: true,
  },
  {
                ...
                >
                  ...
                  <div className="col-md-3">
                    ...
                    <Button
                      ...
                      onClick={toggle}
                    >
                      <i className="fa fa-plus"></i>  Nuevo Procedimiento
                    </Button>
            ...
            <Card>
              <CardBody>
                <DataTable
                  ...
                  noDataComponent={
                    <div className="mt-4">
                      <p>No existen registros de procedimientos</p>
                    </div>
                  }
                />
              </CardBody>
