...
const DataList = ({data, toggle}) => {
    ...
    //const decodedData = decodeURIComponent(name);
    //console.log(name);
    ...
    const filteredItems = data.filter(
        ...
        //item.process_id.user_id.name && item.process_id.user_id.name.toLowerCase().includes(filterText.toLowerCase()) || 
                ...
                <div className='row w-100' style={{margin: 0, padding: 0, border: 0}}>
                    <div className={`col-md-3`}>
                      ...
                      <div className='col-md-3'>
                        {
                            filterText === "" ?
                            <Button color='primary' style={{width: '100%', margin: 0}} value={name} onClick={(e) => {setFilterText(e.target.value === '' ? '' : (e.target.value))}}>Mis Procesos Asignados </Button>   :                        
                                    ...
                                    <Col md='6 col-xxl-4' key={item.id}>
                                        <div className="project-box" style={{height: 425}}>
                                            ...
                                            <Row className="details">
                                                ...
                                                <Col xs="6">
                                                    <p style={{color: 'black', fontWeight: 'bold'}}>{item.process_id.procedures}</p>
                                                </Col>
                                            </Row>
                                        </div>
                                    </Col>
